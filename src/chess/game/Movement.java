...
public class Movement {
	...
	public static void deplacementDiag(int valeurPiece, int x, int y, int l, int c, JLabel possibility) {

		for(int i=1;i<=7;i++) {
			if(l-i>=0 && c-i>=0) {
				if(Main.team.equals("white") && Main.board[l-i][c-i]<0) {
					possibility = Piece.casePossibleKill();
					...
					possibility = Piece.casePossible();
	...
	public static void deplacementLigne(int valeurPiece, int x, int y, int l, int c, JLabel possibility) {
	...
	public static void deplacementCavalier(int valeurPiece, int x, int y, int l, int c, JLabel possibility) {
	...
	public static void deplacementRoi(int valeurPiece, int x, int y, int l, int c, JLabel possibility) {
		if(l>0) {
			if(c>0) {
		...
		if(Main.team.equals("white") && Piece.hasTA1Moved==false && Piece.hasWhiteKingMoved==false && Main.board[7][1]==0 && Main.board[7][2]==0 && Main.board[7][3]==0 && Checked.isWhiteKingAttacked(0, 0)==false) {
			possibility = Piece.casePossible();
			possibility.setLocation(x-150,y);
			Main.panel.add(possibility);
		}
		if(Main.team.equals("white") && Piece.hasTH1Moved==false && Piece.hasWhiteKingMoved==false && Main.board[7][5]==0 && Main.board[7][6]==0 && Checked.isWhiteKingAttacked(0, 0)==false) {
			possibility = Piece.casePossible();
			possibility.setLocation(x+150,y);
			Main.panel.add(possibility);
		}
		if(Main.team.equals("black") && Piece.hasTA8Moved==false && Piece.hasBlackKingMoved==false && Main.board[0][1]==0 && Main.board[0][2]==0 && Main.board[0][3]==0 && Checked.isBlackKingAttacked(0,0)==false) {
			possibility = Piece.casePossible();
			possibility.setLocation(x-150,y);
			Main.panel.add(possibility);
		}
		if(Main.team.equals("black") && Piece.hasTH8Moved==false && Piece.hasBlackKingMoved==false && Main.board[0][5]==0 && Main.board[0][6]==0 && Checked.isBlackKingAttacked(0,0)==false) {
			possibility = Piece.casePossible();
			possibility.setLocation(x+150,y);
			Main.panel.add(possibility);
		}
